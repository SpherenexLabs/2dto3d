...
const App = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const url = 'https://waterdtection-default-rtdb.firebaseio.com/Transformer_Service.json';
        ...
        if (alertConditions.length > 0) {
          setAlertMessage(`ALERT: Your Transformer needs service `);
          setShowAlert(true);
        } else {
          setShowAlert(false);
        }
  ...
  return (
    <div className="container">
      <h1>AI Based Transformer Failure Prediction </h1>
